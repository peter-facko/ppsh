...
pipeline:
	command { pipeline_construct_move_command(&$$, &$1); }
|	pipeline PIPE command { pipeline_append_move_command(&$1, &$3); pipeline_construct_move(&$$, &$1); };
...
command_arguments_redirections:
	command_path { command_construct_move_cmd_path(&$$, &$1); }

...
enum yysymbol_kind_t
{
	...
	YYSYMBOL_SEMIC = 3,			  /* SEMIC  */
	YYSYMBOL_IDF = 4,			  /* IDF  */
	YYSYMBOL_REDIRI = 5,		  /* REDIRI  */
	YYSYMBOL_REDIROT = 6,		  /* REDIROT  */
	YYSYMBOL_REDIROA = 7,		  /* REDIROA  */
	YYSYMBOL_PIPE = 8,			  /* PIPE  */
	YYSYMBOL_EOL = 9,			  /* EOL  */
	YYSYMBOL_YYACCEPT = 10,		  /* $accept  */
	YYSYMBOL_script = 11,		  /* script  */
	YYSYMBOL_pipelines = 12,	  /* pipelines  */
	YYSYMBOL_pipelines_pure = 13, /* pipelines_pure  */
	YYSYMBOL_semic_opt = 14,	  /* semic_opt  */
	YYSYMBOL_pipeline = 15,		  /* pipeline  */
	YYSYMBOL_command = 16,		  /* command  */
	YYSYMBOL_redirections = 17,	  /* redirections  */
	YYSYMBOL_command_arguments_redirections =
		18,							/* command_arguments_redirections  */
	YYSYMBOL_argument = 19,			/* argument  */
	YYSYMBOL_redirection = 20,		/* redirection  */
	YYSYMBOL_redirection_type = 21, /* redirection_type  */
	YYSYMBOL_command_path = 22		/* command_path  */
};
...
static const yytype_int8 yytranslate[] = {
	...
	2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
	2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
	2, 2, 2, 2, 2, 2, 1, 2, 3, 4, 5, 6, 7, 8, 9};

#if YYDEBUG
/* YYRLINE[YYN] -- Source line where rule number YYN was defined.  */
static const yytype_int8 yyrline[] = {0,  30, 30, 31, 34, 35, 38, 39,
									  42, 43, 46, 47, 50, 53, 54, 57,
									  58, 59, 62, 65, 68, 69, 70, 73};
#endif
...
static const yytype_int16 yytoknum[] = {0,	 256, 257, 258, 259,
										260, 261, 262, 263, 264};
#endif
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
static const yytype_int8 yypact[] = {0,	 1,	 -4, 4,	 9,	 -4, -1, -4, 0,
									 2,	 -4, -4, -4, -4, -4, -4, 8,	 -4,
									 12, -4, -4, 9,	 -4, -4, -4, -4, -4};
...
static const yytype_int8 yydefact[] = {13, 0,  2,  8,  6,  10, 0,  1,  13,
									   13, 5,  13, 23, 20, 21, 22, 12, 14,
									   0,  15, 3,  7,  11, 18, 16, 17, 19};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-4, -4, 10, -4, -4, 11, -3,
									  -4, -4, -4, 3,  -4, -4};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 1,	2,	3,	10, 4, 5,
										6,	16, 24, 17, 18, 19};

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
static const yytype_int8 yytable[] = {-4, 7,  -9, 12, 13, 14, 15, 9,  22, -4, 8,
									  -9, 23, 13, 14, 15, 26, 11, 20, 25, 21};

static const yytype_int8 yycheck[] = {0, 0, 0, 4, 5, 6, 7, 3, 11, 9, 9,
									  9, 4, 5, 6, 7, 4, 8, 8, 16, 9};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_int8 yystos[] = {0,	 11, 12, 13, 15, 16, 17, 0,	 9,
									 3,	 14, 8,	 4,	 5,	 6,	 7,	 18, 20,
									 21, 22, 12, 15, 16, 4,	 19, 20, 4};

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_int8 yyr1[] = {0,  10, 11, 11, 12, 12, 13, 13,
								   14, 14, 15, 15, 16, 17, 17, 18,
								   18, 18, 19, 20, 21, 21, 21, 22};

/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static const yytype_int8 yyr2[] = {0, 2, 1, 3, 0, 2, 1, 3, 0, 1, 1, 3,
								   2, 0, 2, 1, 2, 2, 1, 2, 1, 1, 1, 1};
...
#line 35 "main.y"
	{ /*pipelines_debug(&$1);*/
		execute(&(yyvsp[-1].pipelines_pure));
	}
...
#line 39 "main.y"
	{
		pipelines_append_move(&(yyvsp[-2].pipelines_pure),
							  &(yyvsp[0].pipeline));
		pipelines_construct_move(&(yyval.pipelines_pure),
								 &(yyvsp[-2].pipelines_pure));
	}
...
#line 47 "main.y"
	{
		pipeline_append_move_command(&(yyvsp[-2].pipeline),
									 &(yyvsp[0].command));
		pipeline_construct_move(&(yyval.pipeline), &(yyvsp[-2].pipeline));
	}
...
#line 50 "main.y"
	{
		command_combine_redirections_move(
			&(yyvsp[0].command_arguments_redirections),
			&(yyvsp[-1].redirections));
		command_construct_move(&(yyval.command),
							   &(yyvsp[0].command_arguments_redirections));
	}
...
#line 54 "main.y"
	{
		redirections_register_move(&(yyvsp[-1].redirections),
								   &(yyvsp[0].redirection));
		redirections_construct_move(&(yyval.redirections),
									&(yyvsp[-1].redirections));
	}
...
#line 57 "main.y"
	{
		command_construct_move_cmd_path(&(yyval.command_arguments_redirections),
										&(yyvsp[0].command_path));
	}
#line 1129 "/mnt/d/Programming/PPshell/PPshell/parser.c"
	break;

	case 16: /* command_arguments_redirections: command_arguments_redirections
				argument  */
#line 58 "main.y"
	{
		command_register_argument_move(
			&(yyvsp[-1].command_arguments_redirections), &(yyvsp[0].argument));
		command_construct_move(&(yyval.command_arguments_redirections),
							   &(yyvsp[-1].command_arguments_redirections));
	}
#line 1135 "/mnt/d/Programming/PPshell/PPshell/parser.c"
	break;

	case 17: /* command_arguments_redirections: command_arguments_redirections
				redirection  */
#line 59 "main.y"
	{
		command_register_redirection_move(
			&(yyvsp[-1].command_arguments_redirections),
			&(yyvsp[0].redirection));
		command_construct_move(&(yyval.command_arguments_redirections),
							   &(yyvsp[-1].command_arguments_redirections));
...
#line 65 "main.y"
	{
		redirection_init_move(&(yyval.redirection), &(yyvsp[0].IDF),
							  (yyvsp[-1].redirection_type));
	}
...
#line 1181 "/mnt/d/Programming/PPshell/PPshell/parser.c"
